        ...
        <header className="sticky top-0 z-50 w-full bg-white dark:bg-zinc-900 border-b border-slate-200 dark:border-zinc-800 transition-all shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2.5 flex flex-col md:flex-row md:items-center md:justify-between gap-3 w-full">
            ...
            <div className="hidden lg:flex items-center gap-1.5 select-none font-body font-bold text-xs uppercase ml-4">
              ...
              >
                <Flame className="w-3.5 h-3.5 text-pink-655 animate-pulse" />
                <span>वायरल</span>
              </button>
              <button
                onClick={() => {
            ...
            <div className="hidden md:flex items-center justify-end gap-3 flex-1">
              ...
              <div className="flex items-center gap-1">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-7 h-7 rounded-full bg-[#3b5998] hover:scale-110 text-white flex items-center justify-center transition-all cursor-pointer text-xs"
                  title="Facebook"
                >
                  f
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-7 h-7 rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] hover:scale-110 text-white flex items-center justify-center transition-all cursor-pointer text-xs"
                  title="Instagram"
                >
                  📸
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-7 h-7 rounded-full bg-[#ff0000] hover:scale-110 text-white flex items-center justify-center transition-all cursor-pointer text-xs"
                  title="YouTube"
                >
                  ▶
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-7 h-7 rounded-full bg-black hover:scale-110 text-white flex items-center justify-center transition-all cursor-pointer text-[10px] font-black"
                  title="X"
                >
                  X
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-7 h-7 rounded-full bg-[#0088cc] hover:scale-110 text-white flex items-center justify-center transition-all cursor-pointer text-xs"
                  title="Telegram"
                >
                  ✈
                </a>
        ...
        {loading ? (
          ...
          <main className="flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start w-full">
              ...
              <aside className="hidden lg:block lg:col-span-3 sticky top-24 bg-white dark:bg-zinc-900 border border-slate-200/70 dark:border-zinc-800 rounded-2xl p-4 shadow-sm select-none font-body">
                    ...
                    <div className="relative z-20 mt-auto p-5 sm:p-7 text-white text-left font-body flex flex-col gap-3">
                      ...
                      <div className="flex items-center justify-between gap-3 mt-3 pt-3.5 border-t border-white/10 z-20">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            onClick={() => {
                              navigator.clipboard.writeText(`${window.location.origin}/?article=${shortsList[activeShortIndex].id}`);
                              alert("शेयर लिंक कॉपी कर ली गई है!");
                            }}
                            className="p-2 bg-black/40 hover:bg-black/60 rounded-full border border-white/10 text-white flex items-center justify-center cursor-pointer transition-colors active:scale-95"
                            title="साझा करें"
                          >
        ...
        <footer className="bg-[#e4e2e2] dark:bg-zinc-900 border-t border-gray-250 dark:border-zinc-800 py-10 px-4 sm:px-8 mt-12 transition-colors">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-3 flex flex-wrap gap-x-8 gap-y-3.5 items-center md:justify-end text-xs font-mono font-bold">
              <button onClick={() => setSelectedCategory("all")} className="hover:text-brand-red dark:hover:text-red-400 transition-colors">दमदार खबर</button>
              <button onClick={() => setSelectedCategory("all")} className="hover:text-brand-red dark:hover:text-red-400 transition-colors">राजनीति</button>
              <button onClick={() => setSelectedCategory("all")} className="hover:text-brand-red dark:hover:text-red-400 transition-colors">दुनिया</button>
            </div>
          </div>
